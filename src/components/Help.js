...
const Section = (props) => {
  return (
    <div className=" my-4 border-b-2 border-gray-900">
      <div className="flex justify-between">
      <h3 className=" text-lg">{props.title}</h3>
      {props.isVisible ? (
        <button
          className=" cursor-pointer border border-gray-800 text-sm p-1 rounded-lg m-2"
 ...
 const [visibleSection, setVisibleSection]=useState("");
  ...
  return (
    <div className="bg-black m-0 flex justify-center">
      ...
      <div className="heading text-3xl font-semibold font-serif my-5 text-gray-200">FAQs</div>
